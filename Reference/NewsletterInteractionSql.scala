...
trait NewsletterInteractionSql {
  def NEWSLETTER_INTERACTION_DATA_COLLECTION_SQL_SHARED: String = """ SELECT
                                                                    ...
                                                                    |CASE WHEN LOWER(c.domain_payload:user_agent::STRING) LIKE '%native mobile app%' THEN 'DT001'
                                                                    ...
                                                                    |         AND LOWER(c.domain_payload:user_agent::STRING) NOT LIKE '%native_mobile_app%'
                                                                    |       ) THEN 'DT002'
                                                                    ...
                                                                    |IFNULL(interaction_datetime, '2000-01-01 00:00:00'),
                                                                    |IFNULL(block_code, ''),
